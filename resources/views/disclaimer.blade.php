...
@section('title-meta')
    <title>Absolute - Disclaimer</title>
    <meta name="description" content="Disclaimer absolute">
@endsection
@section('content')
    <h2 style="text-align: center;"><b>DISCLAIMER</b></h2>
    <p>Last updated: 2022-08-10</p>
    <p><b>WEBSITE DISCLAIMER</b></p>
    <p>The information provided by <b>Absolute</b> (“Company”, “we”, “our”, “us”) on <b>absolute.nayaunglin.xyz</b> (the
        “Site”) is for general informational purposes only. All information on the Site is provided in good faith, however
    ...
    <p>For example, the outlined <a href="https://policymaker.io/disclaimer/">Disclaimer</a> has been created using <a
            href="https://policymaker.io/">PolicyMaker.io</a>, a free web application for generating high-quality legal
        documents. PolicyMaker’s <a href="https://policymaker.io/disclaimer/">disclaimer generator</a> is an easy-to-use tool
        for creating an excellent sample Disclaimer template for a website, blog, eCommerce store or app.</p>
    ...
    <p>While we have made every attempt to ensure that the information contained in this site has been obtained from
        reliable sources, Absolute is not responsible for any errors or omissions or for the results obtained from the use
        ...
        purpose.</p>
    <p>In no event will Absolute, its related partnerships or corporations, or the partners, agents or employees thereof be
        liable to you or anyone else for any decision made or action taken in reliance on the information in this Site or
        for any consequential, special or similar damages, even if advised of the possibility of such damages.</p>
    <p><b>GUEST CONTRIBUTORS DISCLAIMER</b></p>
    <p>This Site may include content from guest contributors and any views or opinions expressed in such posts are personal
        and do not represent those of Absolute or any of its staff or affiliates unless explicitly stated.</p>
    <p><b>LOGOS AND TRADEMARKS DISCLAIMER</b></p>
    <p>All logos and trademarks of third parties referenced on absolute.nayaunglin.xyz are the trademarks and logos of their
        respective owners. Any inclusion of such trademarks or logos does not imply or constitute any approval, endorsement
        or sponsorship of Absolute by such owners.</p>
    <p><b>CONTACT US</b></p>
    <p>Should you have any feedback, comments, requests for technical support or other inquiries, please contact us by
        email: <b>nayaunglin910@gmail.com</b>.</p>
    <p style="margin-top: 5em; font-size: 0.7em;">This <a href="https://policymaker.io/disclaimer/">Disclaimer</a> was created
        for <b>absolute.nayaunglin.xyz</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-08-10.</p>
@endsection
